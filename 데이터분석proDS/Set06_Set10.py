...
data6 = pd.read_csv('C:/Users/ADMIN/Desktop/proDS/Dataset/Dataset_06.csv')
q6 = pd.pivot_table(data6[['waterfront','price']],index=['waterfront'],values=['price'],aggfunc='mean')
abs(q6['price'][0] - q6['price'][1])
# 1167272
...
q6 = data6[['price','bedrooms','bathrooms','sqft_living','sqft_lot','floors','yr_built']]
a = q6.corr()
	price
...
dir(ols1)
ols1.summary()
q6_out ols1.pvalues.drop('const')
# 유의성을 갖지 않는 변수 목록
q6_out.index[q6_out >= 0.05]
# 유의성 갖지 않는 변수 목록 제거
q6_outlist= q6_out.index[q6_out < 0.05]

form='price~'+'+'.join(x_list)      ## << 답 짧게 찾기
...
# =============================================================================
data7 = pd.read_csv('C:/Users/ADMIN/Desktop/proDS/Dataset/Dataset_07.csv')
df7 = data7[['GRE','TOEFL','CGPA','Chance_of_Admit']]
df7.corr()
...
a = data7['GRE'].mean()
b = data7[data7['GRE'] >= a]['CGPA']
c = data7[data7['GRE'] < a]['CGPA']

q2_out=ttest_ind(b,c,equal_var=True)    # equal_var = 등분산
q2_out.statistic
# 답 19.443291692470982
...
df1 = data7.copy()
df1['Chance_of_Admit'] = np.where(data7['Chance_of_Admit']>0.5,1,0)
logit=LogisticRegression(fit_intercept=False,random_state=12,solver='liblinear')
x_list=data7.columns.drop(['Chance_of_Admit','Serial_No'])
logit.fit(df1[x_list],df1['Chance_of_Admit'])
logit.coef_
...
data10 = pd.read_csv('C:/Users/ADMIN/Desktop/proDS/Dataset/Dataset_10.csv')
q10 = data10[['model','engine_power','age_in_days','km','previous_owners','price']]
q10 = q10.dropna()
q1 = q10[(q10['previous_owners']==1)&(q10['engine_power']==51)]
q2 = pd.pivot_table(q1,index='model',values=['age_in_days','km'],aggfunc='mean')
q2['mean']= q2['km']/q2['age_in_days']
q2['mean'][2]/q2['mean'][0]
#0.97
...
# (답안 예시) 0.23, Y
# =============================================================================
q1_1 = q10[q10['model']=='lounge']['km']/q10[q10['model']=='lounge']['age_in_days']
q1_2 = q10[q10['model']=='sport']['km']/q10[q10['model']=='sport']['age_in_days']
# 같다가 귀무가설 
from scipy.stats import ttest_ind
xxx = ttest_ind(q1_1,q1_2,equal_var=True)
xxx.statistic
