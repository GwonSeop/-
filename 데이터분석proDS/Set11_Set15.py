...
# 활용하시오.(답안 예시) 1
# =============================================================================
data11 = pd.read_csv('C:/Users/ADMIN/Desktop/proDS/Dataset/Dataset_11.csv')
df11 = pd.pivot_table(data11,index=['Country'],values='year',aggfunc='sum')
d_11 = df11[df11['year']!=6048]
len(d_ll['year'])
q1 = data11.groupby('Country').apply(len)
len(q1[q1<3]) # 20
# 3년 연속 행복지수가 기록되지 않는 국가명
list1=q1[q1<3].index
...
dd = pd.pivot_table(basetable,index='Country',columns='year',values='Happiness_Score')
dd['rate']= (dd[2017]-dd[2015])/2
dd['rate'].nlargest(3).index
# 'Latvia', 'Romania', 'Togo'
...
q3 = ols('Happiness_Score~C(year)',data=basetable).fit()  # C()를 이용하여 year의 값이 범주형임을 입력
q3.summary()
anova_lm(q3)
# 0.0042
...
# =============================================================================
data12 = pd.read_csv('C:/Users/ADMIN/Desktop/proDS/Dataset/Dataset_12.csv')
x_list = ['Dependent_Count','is_Married','Read_Book_per_Year']
q1=data12[x_list].corr()
q1
data12.corr()
#0.133
...
# =============================================================================
df12_1 = data12[(data12['Education_Level']=='석사')|(data12['Education_Level']=='박사')]['Read_Book_per_Year']
df12_2 = data12[(data12['Education_Level']=='학사')|(data12['Education_Level']=='고졸')]['Read_Book_per_Year']
q12 = ttest_ind(df12_1,df12_2,equal_var=True)
q12.pvalue
#0.269
...
# (참고)
# from statsmodels.formula.api import ols
q3 = data12[data12['Education_Level']!='고졸']
...
data15 = pd.read_csv('C:/Users/ADMIN/Desktop/proDS/Dataset/Dataset_15_Mart_POS.csv')
q1 = data15.Date.value_counts().idxmax()
data15[data15.Date==q1]['itemDescription'].value_counts().nlargest(1)
data16 = pd.read_csv('C:/Users/ADMIN/Desktop/proDS/Dataset/Dataset_15_item_list.csv')
...
import locale
locale.locale_alias
merge1 = pd.merge(data15, data16, left_on='itemDescription',right_on='prod_nm',how='left')
...
q2_tab=pd.pivot_table(merge2,index='Date',
                      columns='weekday',
...
a = data15['itemDescription'].value_counts()[:10]
l_ = a.index.tolist()
df15 = data15[data15['itemDescription'].isin(l_)].reset_index(drop=False)
df15['day']=pd.to_datetime(df15.Date).dt.day_name(locale='ko_kr') 

q3_tab=pd.pivot_table(df15,index=['Date','day'],values='itemDescription',aggfunc='count').reset_index()
from statsmodels.formula.api import ols
from statsmodels.stats.anova import anova_lm
